...
| Cellular Egress | `crates/cellular` | validated cellular selection, cellular DNS/binding policy, egress observations |
...
Vendor/platform/presentation boundaries are adapters, not additional natural owners.
