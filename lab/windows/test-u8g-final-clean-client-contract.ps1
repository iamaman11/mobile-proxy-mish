...
foreach ($required in @(
    ...
    'error_stack_sanitized',
    'request_failure_message_sanitized',
    'browser_connected_after_error',
    'page_closed_after_error',
    'python_exit_code',
    'request_count',
    'response_count',
    'response_statuses',
    ...
    "'LAB_CAMOUFOX_EXTERNAL_NAVIGATION_FAILED'",
    "'LAB_U8G_DNS_NO_BYPASS_NOT_PROVEN'",
    "'DNS_BEFORE_ROTATION_BROWSER'",
    "'EGRESS_BEFORE_ROTATION_BROWSER'",
    'MISH_U8G_FINAL_EVIDENCE=',
...
foreach ($forbidden in @(
    ...
    'result["error_stack"]',
    'result["request_failure_message"]',
    'headless=False',
