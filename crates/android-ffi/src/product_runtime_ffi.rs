...
pub struct ControlOperationTimingView {
    ...
    pub rotation_terminal_control_state: Option<ControlSessionStateView>,
...
fn map_control_operation_timing(
    ...
    ControlOperationTimingView {
        ...
        post_terminal_transport_connected_ms: timing.post_terminal_transport_connected_ms,
        post_terminal_transport_connections: timing.post_terminal_transport_connections,
